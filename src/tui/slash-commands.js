...
const COMMANDS = [
  ...
  { name: 'bottom', description: '回到最新输出底部', category: 'ui' },
  { name: 'top', description: '跳到最早可见历史', category: 'ui' },
  ...
  { name: 'debug', description: '写入 TUI 调试快照', argumentHint: '[keys|package [out]]', category: 'diagnostic' },
  { name: 'compact', description: '追加会话摘要 checkpoint', category: 'session' },
  ...
  { name: 'board', description: '查看或刷新板端摘要', argumentHint: '[refresh]', category: 'diagnostic' },
  { name: 'redraw', description: '强制重绘终端', category: 'diagnostic' },
...
const DISPLAY_COMMANDS = [
  ...
  { name: 'bottom', description: 'Back to latest output / 回到最新输出底部', category: 'ui' },
  { name: 'top', description: 'Jump to oldest visible history / 跳到最早可见历史', category: 'ui' },
  ...
  { name: 'debug', description: 'Write TUI debug snapshot / 写入 TUI 调试快照', argumentHint: '[keys|package [out]]', category: 'diagnostic' },
  { name: 'compact', description: 'Append session summary checkpoint / 追加会话摘要 checkpoint', category: 'session' },
  ...
  { name: 'board', description: 'Board status / 查看或刷新板端摘要', argumentHint: '[refresh]', category: 'diagnostic' },
  { name: 'redraw', description: 'Force terminal redraw / 强制重绘终端', category: 'diagnostic' },
