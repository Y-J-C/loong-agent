...
module.exports = {
  ...
  loadRuntimeThemeFiles: theme.loadRuntimeThemeFiles,
  loadThemeDefinitionFromFile: theme.loadThemeDefinitionFromFile,
  listThemes: theme.listThemes,
  paint: theme.paint,
  registerThemeDefinition: theme.registerThemeDefinition,
