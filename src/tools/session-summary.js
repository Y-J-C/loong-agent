...
function createSessionSummaryToolDefinition() {
  return {
    ...
    description: 'Read a JSONL session summary, lineage, and recent tool events.',
    category: 'session',
    ...
    promptSnippet: 'Use session_summary to inspect latest or a named session without dumping full JSONL.',
    promptGuidelines: 'Prefer session_summary over read_file for runs/*.jsonl.',
