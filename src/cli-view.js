...
function renderUsage() {
  return [
    ...
    '  node src/index.js log <file> [--json|--no-model]',
    '  node src/index.js log --stdin [--json|--no-model]',
    ...
    '  node src/index.js session resume <session-id-or-path> "继续分析"',
    ...
    '  审计优先: 每次 Agent 运行写入 JSONL session，可 trace/audit/export。',
    '',
    '环境变量:',
