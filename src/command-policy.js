...
const COMMAND_POLICY_METADATA = [
  ...
  { command: 'node scripts/test-tui-runtime-next-runner.js', matchType: 'exact', category: 'diagnostics', level: 'L0', decision: 'allow', description: 'Run Runtime Next TUI tests.', warnings: [] },
  ...
  { command: 'node scripts/test-tui-runtime-theme.js', matchType: 'exact', category: 'diagnostics', level: 'L0', decision: 'allow', description: 'Run Runtime Next theme tests.', warnings: [] },
