...
| Local `test-rpc` can fail with `spawn EPERM` under the Codex sandbox; this is a local execution boundary, not board RPC proof | `troubleshooting`, `source_index`, `unknowns` | `kb/playbooks/rpc-spawn-eperm.md` | `kb/raw/phase5/phase5-local-test-rpc.err`, `kb/raw/phase5/phase5-diagnosis-summary.md` | high |
| Board `test-rpc` passed after the cleanup-boundary fix; `phase5-board-test-rpc.out` records six PASS cases | `troubleshooting`, `source_index` | `kb/playbooks/rpc-spawn-eperm.md` | `kb/raw/phase5/phase5-board-test-rpc.out`, `kb/raw/phase5/phase5-diagnosis-summary.md` | high |
